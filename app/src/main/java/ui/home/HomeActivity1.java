...
public class HomeActivity1 extends AppCompatActivity {
    ...
    private Handler handler = new Handler(){
        public void handleMessage(Message message){
            ...
            for (String fileName : result){
                TextView textView = new TextView(HomeActivity1.this);
        ...
        button_connectToDropBox.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        dropboxApi.getSession().startAuthentication(HomeActivity1.this);
        ...
        button_discconect.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        editor.clear();
                        editor.commit();
                        Toast.makeText(HomeActivity1.this, "Disconnected from Dropbox", Toast.LENGTH_SHORT).show();
                ...
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        mChooser.forResultType(DbxChooser.ResultType.FILE_CONTENT)
                                .launch(HomeActivity1.this, DBX_CHOOSER_REQUEST);
                    }
                }
        );
    }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == DBX_CHOOSER_REQUEST) if (resultCode == Activity.RESULT_OK) {
            ...
            //Map<String, Uri> imageMap = result.getThumbnails();
            //Uri image = imageMap.get("640x480");
